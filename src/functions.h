...
X(AIRSteam_GetDigitalActionData) /* = 135 */
...
X(AIRSteam_SteamInputShutdown) /* = 148 */
X(AIRSteam_DismissFloatingGamepadTextInput) /* = 149 */
/**********************************/
/* Other non-Steamworks functions */
/**********************************/
X(AIRSteam_GetEnv) /* = 150 */
X(AIRSteam_SetEnv) /* = 151 */
/* END GENERATED CODE */
