...
package com.amanitadesign.steam {
	...
	public class FRESteamWorks extends EventDispatcher implements ISteamWorks {
		...
		public function setLEDColor(inputHandle:String, colorR:int, colorG:int, colorB:int, flags:uint):Boolean {
			return _ExtensionContext.call("AIRSteam_SetLEDColor", inputHandle, colorR, colorG, colorB, flags) as Boolean;
		}

		public function triggerVibration(inputHandle:String, leftSpeed:uint, rightSpeed:uint):Boolean {
			return _ExtensionContext.call("AIRSteam_TriggerVibration", inputHandle, leftSpeed, rightSpeed) as Boolean;
		}

		public function getInputTypeForHandle(inputHandle:String):int {
			return _ExtensionContext.call("AIRSteam_GetInputTypeForHandle", inputHandle) as int;
		}

		public function translateActionOrigin(destinationInputType:int, sourceOrigin:String):String {
			return _ExtensionContext.call("AIRSteam_TranslateActionOrigin", destinationInputType, sourceOrigin) as String;
		}
